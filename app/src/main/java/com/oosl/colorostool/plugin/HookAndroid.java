...
public class HookAndroid extends HookBase{
    ...
    public void usbInstall(XC_LoadPackage.LoadPackageParam lpparam){
        ...
        XposedHelpers.findAndHookMethod("com.android.server.pm.OplusPackageInstallInterceptManager", classLoader, "allowInterceptAdbInstallInInstallStage", int.class, "android.content.pm.PackageInstaller$SessionParams", "java.io.File", "java.lang.String", "android.content.pm.IPackageInstallObserver2", new XC_MethodHook() {
            @Override
